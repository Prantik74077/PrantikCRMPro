...
public class Vtigercreatenewpurchaseorder extends WebDriverUtility
{
	...
	@FindBy(xpath="//textarea[@name='bill_street']")
	 ...
	 public void createnewpurchaseorderassignedtouser(String data,String vendordata,String billingaddress,String shippingaddress,String product,String qtydata) throws Throwable
	 {
		    subjecttextb.sendKeys(data);
		    vendornameplusbtn.click();
		    switchToBrowser(driver, "module=Vendors&action");
