...
public class Deliveredpurchaseorder extends BaseClass
{
       ...
       { 
    	   ...
    	   String purchaseordername =poi.getSuccessfulMsg().getText();
    	   Assert.assertTrue(purchaseordername.contains(data));
       }
	   
	   @Test(groups = "regressionTest",retryAnalyzer = com.genericlib.RetryAnalyzer.class)
       public void createpurchaseorderwithdeliveredstatus() throws Throwable
       { 
		   VtigerHomepage vh=new  VtigerHomepage(driver);
    	   u.mouseAction(driver,vh.getMorebutn());
    	   u.visibilityofelement(driver,vh.getPurchaseordertb());
    	   ...
    	   vcp.createnewpurchaseorderwithdeliveredstatus(data, vendordata, billingaddress, shippingaddress, product, qtydata);
